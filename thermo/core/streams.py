...
class GasStream:
    T: pint.Quantity               # temperature [K]
    P: pint.Quantity               # pressure [Pa]
    composition: Composition       # basis set externally
    flow_mass: Optional[pint.Quantity] = None   # [kg/s]
    flow_mol: Optional[pint.Quantity] = None    # [mol/s]
    ...
    def molar_flow(self, M) -> pint.Quantity:
    ...
    def mass_flow(self, M) -> pint.Quantity:
